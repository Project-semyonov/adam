...
describe('Testing TempSensor', () => {
    ...
    it('Testing axios', () => {
        const wrapper = mount(getTemps)
        await flushPromises()
        const getTemp = wrapper.find('[data-testid="message"]')
        expect(getTemp.message).toBe('Got temps from the sensor at ! 🤘 ')
    })
})
